...
protected:
    ...
    --------------------------------------------------------------------------------------------------------
        ...
        {SEARCH_CHECKIN_BROWSER, "Если вы хотите проверить информацию об аккаунте посетите: https://steamdb.info/calculator/ and write: "}
    ...
    ----------------------------------------------------------------------------------------------
        ...
        {SEARCH_CHECKIN_BROWSER, "If you want to check account information please visit: https://steamdb.info/calculator/ and write: "}
    };
};